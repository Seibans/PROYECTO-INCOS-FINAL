//CODIGO PREDECIBLE DE APELLIDOS AL PARECER
// type Usuario = {
// 	id: number;
// 	name: string;
// 	apellidoPat: string;
...
// function actualizarNombres(nombreCompleto: string): Partial<Usuario> {
...
// // Aquí deberías tener la lógica para hacer la actualización en tu base de datos, probablemente usando algún ORM o consulta directa en SQL.
type Usuario = {
	id: number;
	name: string;
	apellidoPat: string;
...
//   // Ejemplos de uso
//   console.log(actualizarNombres("Pablo Fernandez Aduviri")); 
//   // { name: 'Pablo', apellidoPat: 'Fernandez', apellidoMat: 'Aduviri' }
//   console.log(actualizarNombres("Lucas SalAzar")); 
//   // { name: 'Lucas', apellidoPat: 'Salazar', apellidoMat: '' }
//   console.log(actualizarNombres("pepe toño macias angulo")); 
//   // { name: 'Pepe Toño', apellidoPat: 'Macias', apellidoMat: 'Angulo' }
//   console.log(actualizarNombres("LucCILLE")); 
//   // { name: 'Luccille', apellidoPat: '', apellidoMat: '' }
//   console.log(actualizarNombres("LUIS BARRIENtos k SALAZAR MEDINA SOPA")); 
//   // { name: 'Luis Barrientos k Salazar', apellidoPat: 'Medina', apellidoMat: 'Sopa' }
