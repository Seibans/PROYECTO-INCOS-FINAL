...
//             <SideBarItem icon={GiAlienFire} label="Sofia (Ia)" href="/admin/ia" />
...
import { useState, useEffect } from 'react';
import { 
  PanelsTopLeft, Settings, ShieldCheck, CircleHelpIcon, Calendar, Dog, 
  ClipboardPlusIcon, HandCoins, Pill, User2, HeartPulse, Hospital, BatteryLow
} from 'lucide-react';
import { GiAlienFire } from "react-icons/gi";
    ...
    <div className='rounded-l-3xl xl:rounded-r-3xl xl:rounded-l-none bg-lime-200 dark:bg-[#020817]'>
      ...
      <ScrollArea className='h-[90dvh]'>
        <div>
          <div className="p-1 md:p-3">
            <p className="text-slate-500 mb-1">General</p>
            <SideBarItem icon={PanelsTopLeft} label="Datos Generales" href="/admin" exact={true} onClick={onItemClick} />
            <SideBarItem icon={User2} label="Usuarios" href="/admin/usuarios" onClick={onItemClick} />
            <SideBarItem icon={Calendar} label="Agenda" href="/admin/agenda" onClick={onItemClick} />
            <SideBarItem icon={Dog} label="Mascotas" href="/admin/mascotas" onClick={onItemClick} />
            <Accordion
              type="single"
              collapsible
              className="w-full"
            ...
            >
              <AccordionItem value="item-1" className="border-none">
                ...
                <AccordionContent className="pt-1 pb-0 pl-3">
                  <SideBarItem icon={ClipboardPlusIcon} label="Historiales" href="/admin/historiales" onClick={onItemClick} />
                  <SideBarItem icon={HeartPulse} label="Tratamientos" href="/admin/tratamientos" onClick={onItemClick} />
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          ...
          <div className="p-1 md:p-3">
            <p className="text-slate-500 mb-1">Soporte</p>
            <SideBarItem icon={Settings} label="Configuración" href="/admin/configuracion" onClick={onItemClick} />
            <SideBarItem icon={ShieldCheck} label="Seguridad" href="/admin/seguridad" onClick={onItemClick} />
          </div>
          <Separator />
          <div className="p-1 md:p-3">
            <p className="text-slate-500 mb-1">Herramientas</p>
            <SideBarItem icon={CircleHelpIcon} label="Preguntas" href="/admin/preguntas" onClick={onItemClick} />
          </div>
        </div>
        <div className="text-center p-4">
          <Button
