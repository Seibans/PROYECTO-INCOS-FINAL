...
const hexagonData = [
  [Rocket, Music, Bot, Heart],
  [Gamepad, Sparkles, Monitor, Monitor, Laptop],
  [Monitor, Headphones, Moon, MusicNote,  MusicNote, MusicNote],
  [Heart, Camera, Clock, Rocket, Music,  Heart, Flame],
  [Gamepad, Sparkles, Monitor, Monitor, Keyboard, Keyboard],
  [Glasses, Cog, Cherry, Zap, Laptop, ],
  [Microscope, Telescope, Monitor, Satellite],
]

export default function GridHexagonal() {
